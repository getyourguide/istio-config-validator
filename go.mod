...
require (
	github.com/envoyproxy/go-control-plane/envoy v1.32.5-0.20250502135036-f9aa6a9289b4
...
require (
	...
	sigs.k8s.io/gateway-api v1.3.0-rc.1.0.20250404104637-92efbedcc2b4 // indirect
